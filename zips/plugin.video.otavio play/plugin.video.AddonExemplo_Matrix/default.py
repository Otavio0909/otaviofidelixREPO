...
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Filmes e Series para kodi"
...
url_origem = 'https://pastebin.com/raw/CKvu2DAE'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]otavio-play[/COLOR][/B]", [
